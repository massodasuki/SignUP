...
import com.unifreelancer.signup.Firebase.FirebaseDatabaseHelper;
import com.unifreelancer.signup.Firebase.FirebaseUserEntity;
import com.unifreelancer.signup.Helper.Helper;
import com.unifreelancer.signup.R;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editProfileCountry = (EditText)findViewById(R.id.edit_profile_country);
        editProfilePhoneNumber = (EditText)findViewById(R.id.edit_profile_phone_number);
        editProfileHobby = (EditText)findViewById(R.id.edit_profile_hobby);
        editProfileBirthday = (EditText)findViewById(R.id.edit_profile_date_of_birth);

        Button saveEditButton = (Button)findViewById(R.id.edit_profile_save_button);
